...
double CAAInterpolate::Extremum(double Y1, double Y2, double Y3, double Y4, double Y5, double& nm) noexcept
{
  const double A = Y2 - Y1;
  const double B = Y3 - Y2;
...
double CAAInterpolate::Zero(double Y1, double Y2, double Y3) noexcept
{
  const double a = Y2 - Y1;
  const double b = Y3 - Y2;
  const double c = Y1 + Y3 - 2*Y2;
...
double CAAInterpolate::Zero(double Y1, double Y2, double Y3, double Y4, double Y5) noexcept
{
  const double A = Y2 - Y1;
  const double B = Y3 - Y2;
  const double C = Y4 - Y3;
...
double CAAInterpolate::Zero2(double Y1, double Y2, double Y3) noexcept
{
  const double a = Y2 - Y1;
  const double b = Y3 - Y2;
  const double c = Y1 + Y3 - 2*Y2;
...
double CAAInterpolate::Zero2(double Y1, double Y2, double Y3, double Y4, double Y5) noexcept
{
  const double A = Y2 - Y1;
  const double B = Y3 - Y2;
  const double C = Y4 - Y3;
