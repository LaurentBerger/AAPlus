...
double CAAMercury::EclipticLongitude(double JD, bool bHighPrecision) noexcept
{
  ...
  //Calculate L0
  constexpr const int nL0Coefficients = sizeof(g_L0MercuryCoefficients) / sizeof(VSOP87Coefficient);
  double L0 = 0;
  ...
  //Calculate L1
  constexpr const int nL1Coefficients = sizeof(g_L1MercuryCoefficients) / sizeof(VSOP87Coefficient);
  double L1 = 0;
  ...
  //Calculate L2
  constexpr const int nL2Coefficients = sizeof(g_L2MercuryCoefficients) / sizeof(VSOP87Coefficient);
  double L2 = 0;
  ...
  //Calculate L3
  constexpr const int nL3Coefficients = sizeof(g_L3MercuryCoefficients) / sizeof(VSOP87Coefficient);
  double L3 = 0;
  ...
  //Calculate L4
  constexpr const int nL4Coefficients = sizeof(g_L4MercuryCoefficients) / sizeof(VSOP87Coefficient);
  double L4 = 0;
  ...
  //Calculate L5
  constexpr const int nL5Coefficients = sizeof(g_L5MercuryCoefficients) / sizeof(VSOP87Coefficient);
  double L5 = 0;
...
double CAAMercury::EclipticLatitude(double JD, bool bHighPrecision) noexcept
{
  ...
  //Calculate B0
  constexpr const int nB0Coefficients = sizeof(g_B0MercuryCoefficients) / sizeof(VSOP87Coefficient);
  double B0 = 0;
  ...
  //Calculate B1
  constexpr const int nB1Coefficients = sizeof(g_B1MercuryCoefficients) / sizeof(VSOP87Coefficient);
  double B1 = 0;
  ...
  //Calculate B2
  constexpr const int nB2Coefficients = sizeof(g_B2MercuryCoefficients) / sizeof(VSOP87Coefficient);
  double B2 = 0;
  ...
  //Calculate B3
  constexpr const int nB3Coefficients = sizeof(g_B3MercuryCoefficients) / sizeof(VSOP87Coefficient);
  double B3 = 0;
  ...
  //Calculate B4
  constexpr const int nB4Coefficients = sizeof(g_B4MercuryCoefficients) / sizeof(VSOP87Coefficient);
  double B4 = 0;
...
double CAAMercury::RadiusVector(double JD, bool bHighPrecision) noexcept
{
  ...
  //Calculate R0
  constexpr const int nR0Coefficients = sizeof(g_R0MercuryCoefficients) / sizeof(VSOP87Coefficient);
  double R0 = 0;
  ...
  //Calculate R1
  constexpr const int nR1Coefficients = sizeof(g_R1MercuryCoefficients) / sizeof(VSOP87Coefficient);
  double R1 = 0;
  ...
  //Calculate R2
  constexpr const int nR2Coefficients = sizeof(g_R2MercuryCoefficients) / sizeof(VSOP87Coefficient);
  double R2 = 0;
  ...
  //Calculate R3
  constexpr const int nR3Coefficients = sizeof(g_R3MercuryCoefficients) / sizeof(VSOP87Coefficient);
  double R3 = 0;
