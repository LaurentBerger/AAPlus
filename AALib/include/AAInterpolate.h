...
//Static methods
  ...
  static double Extremum(double Y1, double Y2, double Y3, double Y4, double Y5, double& nm) noexcept;
  static double Zero(double Y1, double Y2, double Y3) noexcept;
  static double Zero(double Y1, double Y2, double Y3, double Y4, double Y5) noexcept;
  static double Zero2(double Y1, double Y2, double Y3) noexcept;
  static double Zero2(double Y1, double Y2, double Y3, double Y4, double Y5) noexcept;
};
